...
Window_ChoiceList.prototype.drawItem = function(index) {
    var rect = this.itemRectForText(index);
    var textWidth = this.textWidth(this.commandName(index));
    var offsetX = (rect.width - textWidth) / 2 + 80;  // Center + 80px right
    this.contents.drawText(this.commandName(index), rect.x + offsetX, rect.y, rect.width, this.lineHeight());
};
